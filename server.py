...
def get_ydl_opts():
    ...
    opts = {
        ...
        # 👇 FIX: बहुत लंबे नाम को छोटा कर दो (Max 100 characters)
        'trim_file_name': 100,
...
def home():
    ...
    return jsonify({
        ...
        "cookies": has_cookies,
        "ffmpeg": has_ffmpeg,
        "mode": "Ultimate Mode (Long Filename Fixed)"
    })
...
def download_video():
    ...
    try:
        ...
        # 👇 FIX: नाम को 100 अक्षरों तक ही सीमित रखें
        opts.update({'outtmpl': os.path.join(temp_dir, '%(title).100s.%(ext)s')})
